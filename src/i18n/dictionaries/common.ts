...
export const commonDictionary: Dictionary = {
  ...
  attributes: { uk: "Атрибути", en: "Attributes" },
  attribute_details: { uk: "Деталі", en: "Details" },
  attribute_name: { uk: "Назва", en: "Name" },
  attribute_param_id: { uk: "Param ID", en: "Param ID" },
  attribute_type: { uk: "Тип", en: "Type" },
  attribute_unit: { uk: "Одиниця", en: "Unit" },
  attribute_default: { uk: "За замовчуванням", en: "Default" },
  attribute_status: { uk: "Статус", en: "Status" },
  attribute_required: { uk: "Обовʼязкова", en: "Required" },
  attribute_filterable: { uk: "Фільтрована", en: "Filterable" },
  attribute_active: { uk: "Активна", en: "Active" },
  attribute_required_short: { uk: "Обовʼязк.", en: "Req" },
  attribute_optional_short: { uk: "Необовʼязк.", en: "Opt" },
  attribute_type_placeholder: { uk: "Оберіть тип", en: "Select type" },
  attribute_type_select: { uk: "Список", en: "Select" },
  attribute_type_multiselect: { uk: "Мультивибір", en: "Multiselect" },
  attribute_type_text: { uk: "Текст", en: "Text" },
  attribute_type_number: { uk: "Число", en: "Number" },
  ...
  add_value: { uk: "Додати значення", en: "Add value" },
  edit_value: { uk: "Редагувати значення", en: "Edit value" },
  value_saved: { uk: "Значення збережено", en: "Value saved" },
  value_deleted: { uk: "Значення видалено", en: "Value deleted" },
  bulk_add_value: { uk: "Масове додавання", en: "Bulk add" },
  ...
  load_demo_data: { uk: "Завантажити демо-дані", en: "Load demo data" },
  demo_data_title: { uk: "Завантажити демо-дані", en: "Load demo data" },
  demo_data_description: { uk: "Буде створено 3 магазини, 2 постачальники, 5 категорій, 50 товарів та шаблони характеристик.", en: "Will create 3 shops, 2 suppliers, 5 categories, 50 products and attribute templates." },
  demo_data_loaded: { uk: "Демо-дані завантажені", en: "Demo data loaded" },
  demo_data_failed: { uk: "Не вдалося завантажити демо-дані", en: "Failed to load demo data" },
  demo_data_already_loaded: { uk: "Демо-дані вже завантажені", en: "Demo data already loaded" },
  load_demo_data_confirm: { uk: "Завантажити", en: "Load" },
  demo_shops_count: { uk: "3 магазини", en: "3 shops" },
  demo_shops_products: { uk: "Товари з фото та описами", en: "Products with photos and descriptions" },
  demo_suppliers_count: { uk: "2 постачальники", en: "2 suppliers" },
  ...
  categories_count_suffix: { uk: "категорій", en: "categories" },
  products_count_suffix: { uk: "товарів", en: "products" },
  shops_count_suffix: { uk: "магазинів", en: "shops" },
  suppliers_count_suffix: { uk: "постачальників", en: "suppliers" },
  ...
  limit_tooltip: { uk: "Ліміт", en: "Limit" },
  ...
  dashboard_products_tooltip: { uk: "Товари", en: "Products" },
  dashboard_categories_tooltip: { uk: "Категорії", en: "Categories" },
