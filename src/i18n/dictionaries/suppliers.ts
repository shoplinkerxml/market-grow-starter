...
export const suppliersDictionary: Dictionary = {
  ...
  xml_imports_delete: { uk: "Видалити", en: "Delete" },
  xml_imports_delete_confirm: { uk: "Видалити цей запуск імпорту?", en: "Delete this import run?" },
  xml_imports_deleted: { uk: "Запуск імпорту видалено", en: "Import run deleted" },
  xml_imports_delete_failed: { uk: "Не вдалося видалити запуск", en: "Failed to delete run" },
  xml_imports_page_of: { uk: "Сторінка", en: "Page" },
